...
<%--                            </div>--%>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input-4" name="product_price" required placeholder="Giá" value="${product.price}">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="input-13" class="col-form-label"></label>Rom</label>
