      ...
      <div class="container-heder">
        <div class="img-logo">
          <a href="<%=request.getContextPath()%>/index.jsp">
            <img src="<%=request.getContextPath()%>${logoStore}" alt="Astore" width="150px"
          /></a>
        </div>
      ...
      <div class="container-section">
        <div class="container ${classRightRegister}" id="container">
          <div class="form-container sign-up-container">
            <form action="<%=request.getContextPath()%>/userRegistration" onsubmit="return false" method="post" id="form-sign-up">
...
<%--                ></a>--%>
              ...
              <div class="form-group">
               ...
               <a href="#" style="text-decoration: none"> <b style="color: red; font-size: 12px; font-weight: 100"
          ...
          <div class="form-container sign-in-container">
            <form action="<%=request.getContextPath()%>/userLogin" method="post" id="form-sign-in" ${submitLoadLogin}>
...
<%--                ></a>--%>
              ...
              <a class="forgot" href="<%=request.getContextPath()%>/view/client/sign_user/resetPassword.jsp">Quên mật khẩu?</a>
              <button
                type="submit"
                class="btn-form-sign"
                id="sign-in-load"
    ...
    <script charset="UTF-8" src="<%=request.getContextPath()%>/view/client/assets/js/script.js"></script>
  </body>
</html>
