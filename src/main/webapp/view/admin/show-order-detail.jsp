    ...
    <div class="container-fluid">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody id="tbody">
                                <%int i = 1;%>
                                <c:forEach items="${listDetailOrder}" var="d">
                                    ...
                                    <td>${d.count}</td>
                                    <td>
                                    <button class="btn btn-danger"><a onclick="JSconfirm(${d.id},'Chắc chắn bạn muốn xóa')">Xóa</a></button>
                                    <button class="btn btn-success"><a href="update-detail-order?id=${d.id}">Sửa</a>
                                    </button>
                                    </td>
          ...
          <script>
                                    ...
                                    row += '<input type="hidden" value="delete-detail-order" id="'+value.id+'" style="display: none" />';
