    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 tool-bar">
                <button class="add-catalog"><a href="add-slide">Thêm mới</a></button>
                <div>
                            ...
                            <table class="table table-striped">
                                ...
                                <c:forEach items="${listSlide}" var="h">
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-success"><a href="update-slide?id=${h.id}">Sửa</a>
                                        </button>
                                    </td>
                                </tr>
                                </c:forEach>
            ...
            $.ajax({
                ...
                success: function (responseJson) {
                    ...
                    $.each(responseJson, function (key, value) {
                        ...
                        row += '<td>'+value.linkImage+'</td>';
                        row += '<input type="hidden" value="delete-slide" id="'+value.id+'" style="display: none" />';

                        row += ' <td>';
                        row += '<button class="btn btn-danger"><a onclick="' + onclick + '">Xóa</a></button> \n';
                        row += '<button class="btn btn-success"><a href="update-slide?id='+value.id+'">Sửa</a></button>';
                        row += '        </td>';
                        row += '  </tr>';
