            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-title">Cập nhật ảnh sản phẩm</div>
                        <hr>
                        <form action="update-image-product" method="post">
                            ...
                            <div class="form-group">
                                <label for="input-3">Link ảnh</label>
                                <input type="text" class="form-control" id="input-3" placeholder="Link ảnh"
