...
@WebServlet(name = "SystemStoreController", value = "/systemStore")
public class SystemStoreController extends HttpServlet {
    @Override
...
//        request.setAttribute("systemStoreContent", FooterServices.getInstance().getFooterByTitle("systemStore").getContent());
        request.getRequestDispatcher("view/client/informationStore/systemStore.jsp").forward(request, response);
