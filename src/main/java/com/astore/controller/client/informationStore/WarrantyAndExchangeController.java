...
@WebServlet(name = "WarrantyAndExchangeController", value = "/warrantyAndExchange")
public class WarrantyAndExchangeController extends HttpServlet {
    @Override
...
//        request.setAttribute("warrantyContent", FooterServices.getInstance().getFooterByTitle("warranty").getContent());
        request.getRequestDispatcher("view/client/informationStore/warrantyAndExchange.jsp").forward(request, response);
