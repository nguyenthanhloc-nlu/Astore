...
@WebServlet(name = "ServiceQualityController", value = "/serviceQuality")
public class ServiceQualityController extends HttpServlet {
    @Override
...
//        request.setAttribute("serviceQualityContent", FooterServices.getInstance().getFooterByTitle("serviceQuality").getContent());
        request.getRequestDispatcher("view/client/informationStore/serviceQuality.jsp").forward(request, response);
