...
@WebServlet(name = "StoreRulesController", value = "/storeRules")
public class StoreRulesController extends HttpServlet {
    @Override
...
//        request.setAttribute("storeRulesContent", FooterServices.getInstance().getFooterByTitle("storeRules").getContent());
        request.getRequestDispatcher("view/client/informationStore/storeRules.jsp").forward(request, response);
